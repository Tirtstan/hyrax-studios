...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-4 z-50 px-4 sm:px-6">
      <div className="content-shell flex items-center justify-between gap-2 overflow-visible rounded-full border-2 border-(--ink) bg-[rgba(247,234,223,0.92)] px-3 py-2.5 shadow-[0_7px_0_var(--shadow-ink)] backdrop-blur sm:gap-4 sm:px-4 sm:py-3 md:px-6">
        <a
          href="#top"
        ...
        <nav aria-label="Primary" className="overflow-x-auto overflow-y-visible">
